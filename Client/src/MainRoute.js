...
const MainRoute = (props) => {
  ...
  const logout = () => {
    fetch("http://localhost:9999/logout", {
      ...
      // props.setNewUser(props.r.username="");
    });
  };
  ...
  return (
    <ReactMapGL
      ...
      mapStyle="mapbox://styles/shanky726/ckjg0rntgg4t319mqinqlg4ik"
        ...
        <div className="modal-dialog modal-dialog-centered" role="document">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              <h8><small>-- Send any issue/bugs on shashanky103@gmail.com</small></h8>
              <button
                type="button"
